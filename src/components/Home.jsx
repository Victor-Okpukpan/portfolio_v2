    ...
    data-aos-duration="1000" id="home" className="p-4">
      <div className="max-w-6xl p-3 mx-auto h-screen mt-10 sm:mt-0">
        <div className="w-full h-full flex flex-col justify-center items-start px-5 md:pl-20 tracking-widest">
          <p className="font-bold text-3xl sm:text-4xl lg:text-left text-gray-300 mb-6">
          ...
          <motion.button onClick={() => window.location.replace("#contact")} animate={{y: [0, 12, 2, 0]}} transition={{ repeat: Infinity, duration: 1, delay: 1}} className="text-sm md:text-base font-medium text-gray-400 hover:text-white transition ease-in duration-200 border-purple-600 border py-3 px-8 mb-2 rounded">
            Contact Me
          </motion.button>
